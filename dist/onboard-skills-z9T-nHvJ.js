import { _r as loadModelCatalog, ct as detectBinary, gt as openUrl, xt as resolveNodeManagerOptions } from "./reply-Dxp745JA.js";
import { a as resolveAgentModelPrimary, c as resolveDefaultAgentId, r as resolveAgentDir, s as resolveAgentWorkspaceDir, w as resolveDefaultAgentWorkspaceDir } from "./agent-scope-CrgUOY3f.js";
import { c as defaultRuntime } from "./subsystem-46MXi6Ip.js";
import { f as resolveConfigDir, h as resolveUserPath, s as ensureDir, t as CONFIG_DIR } from "./utils-Dg0Xbl6w.js";
...
import { A as getCustomProviderApiKey, E as SYNTHETIC_DEFAULT_MODEL_REF, H as resolveAuthProfileOrder, P as resolveEnvApiKey, Q as parseOAuthCallbackInput, S as VENICE_DEFAULT_MODEL_REF, X as exchangeChutesCodeForTokens, Y as CHUTES_AUTHORIZE_ENDPOINT, Z as generateChutesPkce, _t as DEFAULT_MODEL, a as modelKey, at as upsertAuthProfile, ft as resolveOpenClawAgentDir, l as resolveConfiguredModelRef, n as buildModelAliasIndex, nt as listProfilesForProvider, o as normalizeProviderId, ot as ensureAuthProfileStore, t as buildAllowedModelSet, vt as DEFAULT_PROVIDER } from "./model-selection-qIT4GiGk.js";
import { t as formatCliCommand } from "./command-format-BQK1OIvH.js";
import { _ as resolveSkillKey, d as hasBinary, i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences } from "./skills-C4b1FA1e.js";
import { J as fetchWithSsrFGuard } from "./deliver-XuTVp_lA.js";
import { t as resolveBrewExecutable } from "./brew-0HRgjHZw.js";
import { $ as setZaiApiKey, A as applyVeniceProviderConfig, B as XIAOMI_DEFAULT_MODEL_REF, C as applyMoonshotProviderConfig, D as applySyntheticConfig, E as applyOpenrouterProviderConfig, F as applyZaiConfig, G as setMinimaxApiKey, H as setAnthropicApiKey, I as KIMI_CODING_MODEL_REF, J as setOpenrouterApiKey, K as setMoonshotApiKey, L as MOONSHOT_DEFAULT_MODEL_REF, M as applyVercelAiGatewayProviderConfig, N as applyXiaomiConfig, O as applySyntheticProviderConfig, P as applyXiaomiProviderConfig, Q as setXiaomiApiKey, R as OPENROUTER_DEFAULT_MODEL_REF, S as applyMoonshotConfigCn, T as applyOpenrouterConfig, U as setGeminiApiKey, V as ZAI_DEFAULT_MODEL_REF, W as setKimiCodingApiKey, X as setVeniceApiKey, Y as setSyntheticApiKey, Z as setVercelAiGatewayApiKey, _ as applyMinimaxProviderConfig, b as applyKimiCodeProviderConfig, d as resolvePluginProviders, et as writeOAuthCredentials, f as applyOpencodeZenConfig, g as applyMinimaxConfig, h as applyMinimaxApiProviderConfig, i as formatTokenK, j as applyVercelAiGatewayConfig, k as applyVeniceConfig, l as createVpsAwareOAuthHandlers, m as applyMinimaxApiConfig, nt as validateAnthropicSetupToken, p as applyOpencodeZenProviderConfig, q as setOpencodeZenApiKey, t as githubCopilotLoginCommand, tt as buildTokenProfileId, u as isRemoteEnvironment, v as applyAuthProfileConfig, w as applyMoonshotProviderConfigCn, x as applyMoonshotConfig, y as applyKimiCodeConfig, z as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF } from "./github-copilot-auth-BKV6Aiag.js";
import { a as enablePluginInConfig } from "./onboard-channels-D4jAA1kf.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CSCMqNZP.js";
import { n as resolveWideAreaDiscoveryDomain } from "./widearea-dns-BIhjVRG1.js";
...
//#endregion
export { applyGoogleGeminiModelDefault as _, applyModelAllowlist as a, promptDefaultModel as c, resolveControlUiRootOverrideSync as d, resolveControlUiRootSync as f, upsertSharedEnvVar as g, applyAuthChoice as h, discoverGatewayBeacons as i, promptModelAllowlist as l, warnIfModelConfigLooksOff as m, installSkill as n, applyModelFallbacksFromSelection as o, resolvePreferredProviderForAuthChoice as p, promptRemoteGatewayConfig as r, applyPrimaryModel as s, setupSkills as t, ensureControlUiAssetsBuilt as u, promptAuthChoiceGrouped as v };