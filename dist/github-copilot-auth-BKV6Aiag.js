import { Z as loadOpenClawPlugins } from "./reply-Dxp745JA.js";
import { N as normalizeAgentId, t as listAgentIds } from "./agent-scope-CrgUOY3f.js";
import { t as createSubsystemLogger } from "./subsystem-46MXi6Ip.js";
import { C as VENICE_MODEL_CATALOG, D as SYNTHETIC_MODEL_CATALOG, E as SYNTHETIC_DEFAULT_MODEL_REF, O as buildSyntheticModelDefinition, S as VENICE_DEFAULT_MODEL_REF, T as SYNTHETIC_BASE_URL, at as upsertAuthProfile, f as resolveModelRefFromString, ft as resolveOpenClawAgentDir, h as buildXiaomiProvider, m as XIAOMI_DEFAULT_MODEL_ID, n as buildModelAliasIndex, o as normalizeProviderId, ot as ensureAuthProfileStore, vt as DEFAULT_PROVIDER, w as buildVeniceModelDefinition, x as VENICE_BASE_URL } from "./model-selection-qIT4GiGk.js";
import { t as formatCliCommand } from "./command-format-BQK1OIvH.js";
import { a as readConfigFileSnapshot, s as writeConfigFile } from "./config-NosW-t65.js";
import { r as isWSLEnv } from "./dispatcher-DWBv9gcW.js";
...
//#endregion
export { setZaiApiKey as $, applyVeniceProviderConfig as A, XIAOMI_DEFAULT_MODEL_REF as B, applyMoonshotProviderConfig as C, applySyntheticConfig as D, applyOpenrouterProviderConfig as E, applyZaiConfig as F, setMinimaxApiKey as G, setAnthropicApiKey as H, KIMI_CODING_MODEL_REF as I, setOpenrouterApiKey as J, setMoonshotApiKey as K, MOONSHOT_DEFAULT_MODEL_REF as L, applyVercelAiGatewayProviderConfig as M, applyXiaomiConfig as N, applySyntheticProviderConfig as O, applyXiaomiProviderConfig as P, setXiaomiApiKey as Q, OPENROUTER_DEFAULT_MODEL_REF as R, applyMoonshotConfigCn as S, applyOpenrouterConfig as T, setGeminiApiKey as U, ZAI_DEFAULT_MODEL_REF as V, setKimiCodingApiKey as W, setVeniceApiKey as X, setSyntheticApiKey as Y, setVercelAiGatewayApiKey as Z, applyMinimaxProviderConfig as _, normalizeAlias as a, applyKimiCodeProviderConfig as b, updateConfig as c, resolvePluginProviders as d, writeOAuthCredentials as et, applyOpencodeZenConfig as f, applyMinimaxConfig as g, applyMinimaxApiProviderConfig as h, formatTokenK as i, applyVercelAiGatewayConfig as j, applyVeniceConfig as k, createVpsAwareOAuthHandlers as l, applyMinimaxApiConfig as m, ensureFlagCompatibility as n, validateAnthropicSetupToken as nt, resolveKnownAgentId as o, applyOpencodeZenProviderConfig as p, setOpencodeZenApiKey as q, formatMs as r, resolveModelTarget as s, githubCopilotLoginCommand as t, buildTokenProfileId as tt, isRemoteEnvironment as u, applyAuthProfileConfig as v, applyMoonshotProviderConfigCn as w, applyMoonshotConfig as x, applyKimiCodeConfig as y, VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF as z };