...
import { C as resolveAuthStorePath, P as resolveConfiguredModelRef, at as resolveEnvApiKey, ht as DEFAULT_PROVIDER, j as normalizeProviderId, mt as DEFAULT_MODEL, pt as DEFAULT_CONTEXT_TOKENS, s as resolveApiKeyForProfile, t as resolveAuthProfileOrder, v as upsertAuthProfile, y as ensureAuthProfileStore } from "./auth-profiles-DIga80Wr.js";
import { t as formatCliCommand } from "./command-format-3xiXujG0.js";
import { D as DEFAULT_AGENT_ID, E as DEFAULT_ACCOUNT_ID, N as normalizeAgentId, c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-jm0ZdXwM.js";
import { f as resolveHomeDir, g as shortenHomePath, h as shortenHomeInString, m as resolveUserPath } from "./utils-PmTbZoD1.js";
import { t as runCommandWithTimeout } from "./exec-BIMFe4XS.js";
import { a as readConfigFileSnapshot, h as parseDurationMs, n as createConfigIO, r as loadConfig, s as writeConfigFile } from "./config-weiOHa8M.js";
import { n as movePathToTrash } from "./server-context-CM_E6wD5.js";
import { n as callGateway, r as randomIdempotencyKey } from "./call-D7AL3vYw.js";
import { l as normalizeMessageChannel, m as GATEWAY_CLIENT_NAMES, p as GATEWAY_CLIENT_MODES } from "./message-channel-CAFcg7mw.js";
...
import { D as runMemoryStatus, E as registerMemoryCli, En as CHANNEL_MESSAGE_ACTION_NAMES, Ln as CHANNEL_TARGETS_DESCRIPTION, Rn as CHANNEL_TARGET_DESCRIPTION, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, f as moveToTrash, fn as lookupContextTokens, gn as runMessageAction, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, s as detectBrowserOpenSupport, un as resolveCommitHash, v as resolveControlUiLinks, wn as formatTargetDisplay, x as waitForGatewayReachable } from "./loader-DX0InoAJ.js";
...
import { n as setupChannels } from "./onboard-channels-CwbpG2fS.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-RvF0P6tQ.js";
import { d as loadSessionStore } from "./sandbox-CRdrs_Gg.js";
import { r as runCommandWithRuntime } from "./cli-utils-DFbPmfWB.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-YDqjSpfz.js";
import { a as getFlagValue, c as getVerboseFlag, l as hasFlag, o as getPositiveIntFlagValue, r as registerSubCliCommands } from "./register.subclis-DuQAUmQk.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-uGhPZ_kK.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-DMvN-OOc.js";
import { t as createDefaultDeps } from "./deps-Ed23SGbm.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-SKaYGaNK.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DvBpNsbR.js";
import { t as resolveGatewayService } from "./service-BoDHq_LN.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-DAgZTW06.js";
import { t as renderTable } from "./table-f0EgX-YI.js";
import { d as applyAuthChoice, f as upsertSharedEnvVar, m as promptAuthChoiceGrouped, p as applyGoogleGeminiModelDefault, u as warnIfModelConfigLooksOff } from "./onboard-skills-94OExfmh.js";
import { i as healthCommand } from "./health-format-BIiaWjlE.js";
import { $ as setZaiApiKey, D as applySyntheticConfig, F as applyZaiConfig, G as setMinimaxApiKey, H as setAnthropicApiKey, J as setOpenrouterApiKey, K as setMoonshotApiKey, N as applyXiaomiConfig, Q as setXiaomiApiKey, S as applyMoonshotConfigCn, T as applyOpenrouterConfig, U as setGeminiApiKey, W as setKimiCodingApiKey, X as setVeniceApiKey, Y as setSyntheticApiKey, Z as setVercelAiGatewayApiKey, f as applyOpencodeZenConfig, g as applyMinimaxConfig, j as applyVercelAiGatewayConfig, k as applyVeniceConfig, m as applyMinimaxApiConfig, nt as validateAnthropicSetupToken, q as setOpencodeZenApiKey, tt as buildTokenProfileId, v as applyAuthProfileConfig, x as applyMoonshotConfig, y as applyKimiCodeConfig } from "./github-copilot-auth-jP1YSFW_.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-BnUUuH3y.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status--PMzPUA7.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-Dnaf2rhw.js";
import { t as formatHelpExamples } from "./help-format-af1XWYxC.js";
import { a as CONFIGURE_WIZARD_SECTIONS, n as configureCommandWithSections, t as configureCommand } from "./configure-D-eR13X8.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CTe0ZDxD.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-CIgC78Ch.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-l2gQjjaO.js");
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	let hint;
	if (!options.noOpen) {
		if ((await detectBrowserOpenSupport()).ok) opened = await openUrl(authedUrl);
