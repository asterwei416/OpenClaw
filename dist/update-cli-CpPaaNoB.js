...
import { n as replaceCliName, r as resolveCliName, t as formatCliCommand } from "./command-format-3xiXujG0.js";
...
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-D5D7b3cX.js";
import "./archive-mFgwsll-.js";
import "./installs-C5cjVarj.js";
import { o as trimLogTail } from "./restart-sentinel-DywisDen.js";
import { r as parseSemver } from "./runtime-guard-DvBpNsbR.js";
import { t as renderTable } from "./table-f0EgX-YI.js";
import { a as globalInstallArgs, c as compareSemverStrings, d as DEFAULT_GIT_CHANNEL, f as DEFAULT_PACKAGE_CHANNEL, g as resolveEffectiveUpdateChannel, h as normalizeUpdateChannel, i as detectGlobalInstallManagerForRoot, l as fetchNpmTagVersion, m as formatUpdateChannelLabel, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, p as channelToNpmTag, r as detectGlobalInstallManagerByPresence, s as checkUpdateStatus, t as runGatewayUpdate, u as resolveNpmChannelTag } from "./update-runner-8XFxQglY.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-C6Ud1gNT.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-BIB5jGcv.js";
...
async function updateCommand(opts) {
	...
	if (shouldRestart) {
		...
		try {
			const { runDaemonRestart } = await import("./daemon-cli-BS27vjyt.js");
			...
			if (!opts.json && restarted) {
				...
				try {
					const { doctorCommand } = await import("./doctor-7zlmB2yw.js");
