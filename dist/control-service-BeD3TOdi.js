...
import { a as resolveProfile, i as resolveBrowserConfig, t as createBrowserRouteContext } from "./server-context-D2cv-pIA.js";
...
async function stopBrowserControlService() {
	...
	state = null;
	try {
		await (await import("./pw-ai-DlTBXZjY.js")).closePlaywrightBrowserConnection();
	} catch {}
}
