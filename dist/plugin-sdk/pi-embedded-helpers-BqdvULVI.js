import { G as CHANNEL_IDS, J as normalizeAnyChannelId, K as CHAT_CHANNEL_ORDER, Q as requireActivePluginRegistry, S as resolveConfigDir, X as normalizeChatChannelId, Z as getActivePluginRegistry, l as createSubsystemLogger, m as CONFIG_DIR, n as runExec, q as getChatChannelMeta, u as defaultRuntime, w as resolveUserPath, x as normalizeE164 } from "./exec-CjyVHUuE.js";
import { E as resolveWhatsAppAccount, d as normalizePluginsConfig, f as resolveEnableState, i as writeConfigFile, l as LEGACY_MANIFEST_KEYS, p as resolveMemorySlotDecision, s as loadPluginManifestRegistry, t as loadConfig, u as MANIFEST_KEY } from "./config-CG5qbrpw.js";
import { A as normalizeAccountId$1, C as resolveOpenClawPackageRootSync, D as buildAgentMainSessionKey, M as normalizeMainKey, N as resolveAgentIdFromSessionKey, T as DEFAULT_AGENT_ID, _ as DEFAULT_TOOLS_FILENAME, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, j as normalizeAgentId, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, w as DEFAULT_ACCOUNT_ID, y as ensureAgentWorkspace } from "./agent-scope-qNPdmst1.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-BFxmmTT5.js";
import { G as isTruthyEnvValue, K as parseBooleanValue } from "./model-selection-DDdslEWo.js";
import { t as formatCliCommand } from "./command-format-CFzL448l.js";
import { r as resolveSessionTranscriptPath, t as resolveDefaultSessionStorePath } from "./paths-Bkjq_KcG.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DOI14YeV.js";
import { C as DEFAULT_OPENCLAW_BROWSER_ENABLED, D as formatErrorMessage, E as extractErrorCode, S as DEFAULT_OPENCLAW_BROWSER_COLOR, _ as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, a as resolveOpenClawUserDataDir, b as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as stopChromeExtensionRelayServer, h as ensureChromeExtensionRelayServer, i as launchOpenClawChrome, l as createTargetViaCdp, m as getHeadersWithAuth, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, w as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, x as DEFAULT_BROWSER_EVALUATE_ENABLED, y as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./chrome-DMuEXuKT.js";
...
const log$1 = createSubsystemLogger("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
	...
	if (hasDimensions && (width > params.maxDimensionPx || height > params.maxDimensionPx || overBytes)) log$1.warn("Image exceeds limits; resizing", {
		label: params.label,
		width,
		height,
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BN7Cwl9J.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BN7Cwl9J.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { sanitizeGoogleTurnOrdering as $, normalizeWhatsAppTarget as $n, resolveSessionResetPolicy as $t, resolveSandboxRuntimeStatus as A, normalizeSlackMessagingTarget as An, resolveToolsBySender as Ar, isGifMedia as At, applySkillEnvOverrides as B, resolveDiscordGroupRequireMention as Bn, updateLastRoute as Bt, isRawApiErrorPayload as C, listSlackDirectoryGroupsFromConfig as Cn, listEnabledDiscordAccounts as Cr, optimizeImageToPng as Ct, sanitizeUserFacingText as D, listWhatsAppDirectoryGroupsFromConfig as Dn, resolveChannelGroupPolicy as Dr, getFileExtension as Dt, parseImageSizeError as E, listTelegramDirectoryPeersFromConfig as En, normalizeDiscordToken as Er, extensionForMime as Et, buildWorkspaceSkillCommandSpecs as F, requireTargetKind as Fn, appendAssistantMessageToSessionTranscript as Ft, expandPolicyWithPluginGroups as G, resolveIMessageGroupToolPolicy as Gn, deliveryContextFromSession as Gt, resolveSandboxConfigForAgent as H, resolveGoogleChatGroupRequireMention as Hn, updateSessionStoreEntry as Ht, buildWorkspaceSkillSnapshot as I, getChannelDock as In, resolveMirroredTranscriptText as It, resolveToolProfilePolicy as J, resolveTelegramGroupRequireMention as Jn, normalizeDeliveryContext as Jt, expandToolGroups as K, resolveSlackGroupRequireMention as Kn, deliveryContextKey as Kt, loadWorkspaceSkillEntries as L, listChannelDocks as Ln, loadSessionStore as Lt, registerBrowserRoutes as M, resolveSlackChannelId as Mn, MAX_IMAGE_BYTES$1 as Mt, resolveBrowserConfig as N, buildMessagingTarget as Nn, maxBytesForKind as Nt, ensureSandboxWorkspaceForSession as O, listWhatsAppDirectoryPeersFromConfig as On, resolveChannelGroupRequireMention as Or, imageMimeFromFormat as Ot, resolveProfile as P, ensureTargetId as Pn, mediaKindFromMime as Pt, resolveBootstrapMaxChars as Q, isWhatsAppGroupJid as Qn, resolveChannelResetConfig as Qt, resolveSkillsPromptForRun as R, resolveBlueBubblesGroupRequireMention as Rn, readSessionUpdatedAt as Rt, isRateLimitAssistantError as S, listDiscordDirectoryPeersFromConfig as Sn, listDiscordAccountIds as Sr, hasAlphaChannel as St, parseImageDimensionError as T, listTelegramDirectoryGroupsFromConfig as Tn, resolveDiscordAccount as Tr, detectMime as Tt, buildPluginToolGroups as U, resolveGoogleChatGroupToolPolicy as Un, isCacheEnabled as Ut, applySkillEnvOverridesFromSnapshot as V, resolveDiscordGroupToolPolicy as Vn, updateSessionStore as Vt, collectExplicitAllowlist as W, resolveIMessageGroupRequireMention as Wn, resolveCacheTtlMs as Wt, buildBootstrapContextFiles as X, resolveWhatsAppGroupRequireMention as Xn, resolveSessionKey as Xt, stripPluginOnlyAllowlist as Y, resolveTelegramGroupToolPolicy as Yn, normalizeSessionDeliveryFields as Yt, ensureSessionHeader as Z, resolveWhatsAppGroupToolPolicy as Zn, evaluateSessionFreshness as Zt, isCompactionFailureError as _, GATEWAY_CLIENT_NAMES as _n, resolveDefaultSignalAccountId as _r, resolvePinnedHostnameWithPolicy as _t, isMessagingToolDuplicateNormalized as a, resolveConversationLabel as an, listBindings as ar, normalizeThinkLevel as at, isFailoverErrorMessage as b, normalizeChannelId as bn, resolveDefaultIMessageAccountId as br, convertHeicToJpeg as bt, downgradeOpenAIReasoningBlocks as c, isDeliverableMessageChannel as cn, listSlackAccountIds as cr, resolveResponseUsageMode as ct, classifyFailoverReason as d, listDeliverableMessageChannels as dn, resolveSlackReplyToMode as dr, getMediaDir as dt, resolveSessionResetType as en, listEnabledTelegramAccounts as er, formatThinkingLevels as et, formatAssistantErrorText as f, normalizeMessageChannel as fn, resolveSlackAppToken as fr, saveMediaBuffer as ft, isCloudCodeAssistFormatError as g, GATEWAY_CLIENT_MODES as gn, listSignalAccountIds as gr, resolvePinnedHostname as gt, isAuthAssistantError as h, GATEWAY_CLIENT_IDS as hn, listEnabledSignalAccounts as hr, createPinnedDispatcher as ht, isMessagingToolDuplicate as i, deriveSessionMetaPatch as in, resolveTelegramToken as ir, normalizeReasoningLevel as it, createBrowserRouteContext as j, parseSlackTarget as jn, kindFromMime as jt, resolveSandboxContext as k, looksLikeSlackTargetId as kn, resolveChannelGroupToolsPolicy as kr, isAudioFileName as kt, isAntigravityClaude as l, isInternalMessageChannel as ln, resolveDefaultSlackAccountId as lr, supportsXHighThinking as lt, getApiErrorPayloadFingerprint as m, resolveMessageChannel as mn, normalizeChatType as mr, closeDispatcher as mt, validateGeminiTurns as n, DEFAULT_RESET_TRIGGERS as nn, resolveDefaultTelegramAccountId as nr, listThinkingLevels as nt, normalizeTextForComparison as o, resolveGroupSessionKey as on, buildSlackThreadingToolContext as or, normalizeUsageDisplay as ot, formatRawAssistantErrorForUi as p, resolveGatewayMessageChannel as pn, resolveSlackBotToken as pr, SsrFBlockedError as pt, normalizeToolName as q, resolveSlackGroupToolPolicy as qn, mergeDeliveryContext as qt, pickFallbackThinkingLevel as r, resolveMainSessionKey as rn, resolveTelegramAccount as rr, normalizeElevatedLevel as rt, sanitizeSessionMessagesImages as s, INTERNAL_MESSAGE_CHANNEL as sn, listEnabledSlackAccounts as sr, normalizeVerboseLevel as st, validateAnthropicTurns as t, resolveThreadFlag as tn, listTelegramAccountIds as tr, formatXHighModelHint as tt, isGoogleModelApi as u, isMarkdownCapableMessageChannel as un, resolveSlackAccount as ur, extractOriginalFilename as ut, isContextOverflowError as v, getChannelPlugin as vn, resolveSignalAccount as vr, sanitizeImageBlocks as vt, isTimeoutErrorMessage as w, listSlackDirectoryPeersFromConfig as wn, resolveDefaultDiscordAccountId as wr, resizeToJpeg as wt, isLikelyContextOverflowError as x, listDiscordDirectoryGroupsFromConfig as xn, resolveIMessageAccount as xr, getImageMetadata as xt, isFailoverAssistantError as y, listChannelPlugins as yn, listIMessageAccountIds as yr, sanitizeToolResultImages as yt, resolvePluginSkillDirs as z, resolveBlueBubblesGroupToolPolicy as zn, recordSessionMetaFromInbound as zt };