...
import * as _sinclair_typebox1886 from "@sinclair/typebox";
...
//#endregion
//#region src/config/types.feishu.d.ts
type FeishuGroupConfig = {
  requireMention?: boolean; /** Optional tool policy overrides for this group. */
  tools?: GroupToolPolicyConfig;
  toolsBySender?: GroupToolPolicyBySenderConfig; /** If specified, only load these skills for this group. Omit = all skills; empty = no skills. */
  skills?: string[]; /** If false, disable the bot for this group. */
  enabled?: boolean; /** Optional allowlist for group senders (open_ids). */
  allowFrom?: Array<string | number>; /** Optional system prompt snippet for this group. */
  systemPrompt?: string;
};
type FeishuAccountConfig = {
  /** Optional display name for this account (used in CLI/UI lists). */name?: string; /** Feishu app ID (cli_xxx). */
  appId?: string; /** Feishu app secret. */
  appSecret?: string; /** Path to file containing app secret (for secret managers). */
  appSecretFile?: string; /** API domain override: "feishu" (default), "lark" (global), or full https:// domain. */
  domain?: string; /** Bot display name (used for streaming card title). */
  botName?: string; /** If false, do not start this Feishu account. Default: true. */
  enabled?: boolean; /** Markdown formatting overrides (tables). */
  markdown?: MarkdownConfig; /** Override native command registration for Feishu (bool or "auto"). */
  commands?: ProviderCommandsConfig; /** Allow channel-initiated config writes (default: true). */
   ...
   */
  groupPolicy?: GroupPolicy; /** Allowlist for DM senders (open_id or union_id). */
  allowFrom?: Array<string | number>; /** Optional allowlist for Feishu group senders. */
  groupAllowFrom?: Array<string | number>; /** Max group messages to keep as history context (0 disables). */
  historyLimit?: number; /** Max DM turns to keep as history context. */
  dmHistoryLimit?: number; /** Per-DM config overrides keyed by user open_id. */
  dms?: Record<string, DmConfig>; /** Per-group config keyed by chat_id (oc_xxx). */
  groups?: Record<string, FeishuGroupConfig>; /** Outbound text chunk size (chars). Default: 2000. */
  textChunkLimit?: number; /** Chunking mode: "length" (default) splits by size; "newline" splits on every newline. */
  chunkMode?: "length" | "newline"; /** Disable block streaming for this account. */
   ...
   * Default: true.
   */
  streaming?: boolean; /** Media max size in MB. */
  mediaMaxMb?: number; /** Retry policy for outbound Feishu API calls. */
  retry?: OutboundRetryConfig; /** Heartbeat visibility settings for this channel. */
  heartbeat?: ChannelHeartbeatVisibilityConfig;
};
type FeishuConfig = {
  /** Optional per-account Feishu configuration (multi-account). */accounts?: Record<string, FeishuAccountConfig>; /** Top-level app ID (alternative to accounts). */
  appId?: string; /** Top-level app secret (alternative to accounts). */
  appSecret?: string; /** Top-level app secret file (alternative to accounts). */
...
type IMessageAccountConfig = {
  ...
  mediaMaxMb?: number; /** Outbound text chunk size (chars). Default: 4000. */
  textChunkLimit?: number; /** Chunking mode: "length" (default) splits by size; "newline" splits on every newline. */
  chunkMode?: "length" | "newline";
  blockStreaming?: boolean; /** Merge streamed block replies before sending. */
  blockStreamingCoalesce?: BlockStreamingCoalesceConfig;
...
type TelegramTopicConfig = {
  requireMention?: boolean; /** If specified, only load these skills for this topic. Omit = all skills; empty = no skills. */
...
type WhatsAppConfig = {
   ...
   */
  messagePrefix?: string; /** Direct message access policy (default: pairing). */
  dmPolicy?: DmPolicy;
  /**
...
type WhatsAppAccountConfig = {
  ...
  messagePrefix?: string; /** Override auth directory (Baileys multi-file auth state). */
...
type CronIsolation = {
   ...
   */
  postToMainMode?: "summary" | "full"; /** Max chars when postToMainMode="full". Default: 8000. */
...
declare const ConnectParamsSchema: _sinclair_typebox1886.TObject<{
  minProtocol: _sinclair_typebox1886.TInteger;
  maxProtocol: _sinclair_typebox1886.TInteger;
  client: _sinclair_typebox1886.TObject<{
    id: _sinclair_typebox1886.TUnion<_sinclair_typebox1886.TLiteral<"cli" | "webchat" | "webchat-ui" | "openclaw-control-ui" | "gateway-client" | "openclaw-macos" | "openclaw-ios" | "openclaw-android" | "node-host" | "test" | "fingerprint" | "openclaw-probe">[]>;
    displayName: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
    version: _sinclair_typebox1886.TString;
    platform: _sinclair_typebox1886.TString;
    deviceFamily: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
    modelIdentifier: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
    mode: _sinclair_typebox1886.TUnion<_sinclair_typebox1886.TLiteral<"node" | "cli" | "webchat" | "ui" | "backend" | "test" | "probe">[]>;
    instanceId: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
  }>;
  caps: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TArray<_sinclair_typebox1886.TString>>;
  commands: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TArray<_sinclair_typebox1886.TString>>;
  permissions: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TRecord<_sinclair_typebox1886.TString, _sinclair_typebox1886.TBoolean>>;
  pathEnv: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
  role: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
  scopes: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TArray<_sinclair_typebox1886.TString>>;
  device: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TObject<{
    id: _sinclair_typebox1886.TString;
    publicKey: _sinclair_typebox1886.TString;
    signature: _sinclair_typebox1886.TString;
    signedAt: _sinclair_typebox1886.TInteger;
    nonce: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
  }>>;
  auth: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TObject<{
    token: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
    password: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
  }>>;
  locale: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
  userAgent: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TString>;
}>;
declare const ErrorShapeSchema: _sinclair_typebox1886.TObject<{
  code: _sinclair_typebox1886.TString;
  message: _sinclair_typebox1886.TString;
  details: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TUnknown>;
  retryable: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TBoolean>;
  retryAfterMs: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TInteger>;
}>;
declare const RequestFrameSchema: _sinclair_typebox1886.TObject<{
  type: _sinclair_typebox1886.TLiteral<"req">;
  id: _sinclair_typebox1886.TString;
  method: _sinclair_typebox1886.TString;
  params: _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TUnknown>;
}>;
//#endregion
...
type ResponsePrefixContext = {
  /** Short model name (e.g., "gpt-5.2", "claude-opus-4-5") */model?: string; /** Full model ID including provider (e.g., "openai-codex/gpt-5.2") */
...
declare function registerMemoryCli(program: Command$1): void;
//#endregion
...
declare function stringEnum<T extends readonly string[]>(values: T, options?: StringEnumOptions<T>): _sinclair_typebox1886.TUnsafe<T[number]>;
declare function optionalStringEnum<T extends readonly string[]>(values: T, options?: StringEnumOptions<T>): _sinclair_typebox1886.TOptional<_sinclair_typebox1886.TUnsafe<T[number]>>;
//#endregion
...
//#endregion
//#region src/feishu/accounts.d.ts
type FeishuTokenSource = "config" | "file" | "env" | "none";
...
declare function listFeishuAccountIds(cfg: OpenClawConfig): string[];
declare function resolveDefaultFeishuAccountId(cfg: OpenClawConfig): string;
declare function resolveFeishuAccount(params: {
  cfg: OpenClawConfig;
  accountId?: string | null;
}): ResolvedFeishuAccount;
//#endregion
//#region src/feishu/config.d.ts
 ...
 */
declare function resolveFeishuConfig(params: {
  cfg: OpenClawConfig;
  accountId?: string;
 ...
 */
declare function resolveFeishuGroupRequireMention(params: {
  cfg: OpenClawConfig;
  accountId?: string;
  chatId: string;
}): boolean;
 ...
 */
declare function resolveFeishuGroupEnabled(params: {
  cfg: OpenClawConfig;
  accountId?: string;
  chatId: string;
}): boolean;
//#endregion
//#region src/channels/plugins/outbound/feishu.d.ts
declare const feishuOutbound: ChannelOutboundAdapter;
//#endregion
//#region src/channels/plugins/normalize/feishu.d.ts
declare function normalizeFeishuTarget(raw: string): string;
//#endregion
//#region src/feishu/probe.d.ts
type FeishuProbe = {
  ok: boolean;
  error?: string | null;
  elapsedMs: number;
...
declare function probeFeishu(appId: string, appSecret: string, timeoutMs?: number, domain?: string): Promise<FeishuProbe>;
//#endregion
//#region src/feishu/monitor.d.ts
