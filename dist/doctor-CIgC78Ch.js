...
import { I as resolveHooksGmailModel, O as getModelRefStatus, P as resolveConfiguredModelRef, S as updateAuthProfileStoreWithLock, _t as CLAUDE_CLI_PROFILE_ID, ht as DEFAULT_PROVIDER, mt as DEFAULT_MODEL, o as resolveProfileUnusableUntilForDisplay, p as repairOAuthProfileIdMismatch, s as resolveApiKeyForProfile, vt as CODEX_CLI_PROFILE_ID, y as ensureAuthProfileStore } from "./auth-profiles-DIga80Wr.js";
import { t as formatCliCommand } from "./command-format-3xiXujG0.js";
import { E as DEFAULT_ACCOUNT_ID, N as normalizeAgentId, O as DEFAULT_MAIN_KEY, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, k as buildAgentMainSessionKey, s as resolveAgentWorkspaceDir } from "./agent-scope-jm0ZdXwM.js";
import { _ as sleep, f as resolveHomeDir$1, g as shortenHomePath } from "./utils-PmTbZoD1.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-BIMFe4XS.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-Dean7Fp2.js";
import { a as readConfigFileSnapshot, s as writeConfigFile, t as migrateLegacyConfig, u as OpenClawSchema } from "./config-weiOHa8M.js";
import { f as inspectPortUsage, m as formatPortDiagnostics } from "./errors-DdT2Dtkb.js";
import { a as resolveGatewayBindHost, n as isLoopbackHost } from "./net-DaJz_a4n.js";
...
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CpdCQwk9.js";
import { n as listChannelPlugins } from "./plugins-TrKFfrLt.js";
import { Kt as loadModelCatalog, _ as randomToken, a as applyWizardMetadata, h as printWizardHeader, t as loadOpenClawPlugins, u as guardCancel } from "./loader-DX0InoAJ.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-D5D7b3cX.js";
import { t as note$1 } from "./note-CBiVaqG7.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-DfgBr1D5.js";
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath } from "./paths-RvF0P6tQ.js";
import { $ as DEFAULT_SANDBOX_BROWSER_IMAGE, I as resolveMainSessionKey, N as canonicalizeMainSessionAlias, W as resolveSandboxScope, d as loadSessionStore, et as DEFAULT_SANDBOX_COMMON_IMAGE, m as saveSessionStore, tt as DEFAULT_SANDBOX_IMAGE } from "./sandbox-CRdrs_Gg.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-B8VT67wB.js";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, m as resolveNodeLaunchAgentLabel } from "./constants-CLUi6T-M.js";
...
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-SKaYGaNK.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-BoDHq_LN.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-DAgZTW06.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-okqOoOug.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-__5IBcxf.js";
import { i as healthCommand, t as formatHealthCheckFailure } from "./health-format-BIiaWjlE.js";
import { t as runGatewayUpdate } from "./update-runner-8XFxQglY.js";
...
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BbgrAZxT.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CTe0ZDxD.js";
