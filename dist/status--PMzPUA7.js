...
import { P as resolveConfiguredModelRef, ht as DEFAULT_PROVIDER, mt as DEFAULT_MODEL, pt as DEFAULT_CONTEXT_TOKENS, y as ensureAuthProfileStore } from "./auth-profiles-DIga80Wr.js";
import { t as formatCliCommand } from "./command-format-3xiXujG0.js";
import { H as parseAgentSessionKey, N as normalizeAgentId, c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-jm0ZdXwM.js";
...
import { M as VERSION, a as readConfigFileSnapshot, r as loadConfig, s as writeConfigFile } from "./config-weiOHa8M.js";
import { f as inspectPortUsage, m as formatPortDiagnostics } from "./errors-DdT2Dtkb.js";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-BUcKO8Rr.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-D7AL3vYw.js";
import { n as listChannelPlugins } from "./plugins-TrKFfrLt.js";
import { Jt as loadProviderUsageSummary, Qt as listAgentsForGateway, Sr as getMemorySearchManager, Vn as peekSystemEvents, Yt as formatUsageReportLines, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, fn as lookupContextTokens, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, p as normalizeGatewayTokenInput, q as getRemoteSkillEligibility, s as detectBrowserOpenSupport, v as resolveControlUiLinks, w as normalizeControlUiBasePath, x as waitForGatewayReachable } from "./loader-DX0InoAJ.js";
...
import { o as resolveStorePath } from "./paths-RvF0P6tQ.js";
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-CRdrs_Gg.js";
import { t as buildChannelSummary } from "./channel-summary-By1mArPa.js";
import { a as summarizeRestartSentinel, i as readRestartSentinel } from "./restart-sentinel-DywisDen.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DRXQXvhY.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-SKaYGaNK.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-BoDHq_LN.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-DAgZTW06.js";
import { o as readLastGatewayErrorLine } from "./service-audit-__5IBcxf.js";
import { t as renderTable } from "./table-f0EgX-YI.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-CujrC1p4.js";
import { d as applyAuthChoice, h as ensureControlUiAssetsBuilt, l as resolvePreferredProviderForAuthChoice, m as promptAuthChoiceGrouped, o as applyPrimaryModel, r as promptRemoteGatewayConfig, s as promptDefaultModel, t as setupSkills, u as warnIfModelConfigLooksOff } from "./onboard-skills-94OExfmh.js";
import { a as resolveHeartbeatSummaryForAgent, i as healthCommand, n as formatHealthChannelLines, t as formatHealthCheckFailure } from "./health-format-BIiaWjlE.js";
import { c as compareSemverStrings, g as resolveEffectiveUpdateChannel, h as normalizeUpdateChannel, m as formatUpdateChannelLabel, s as checkUpdateStatus } from "./update-runner-8XFxQglY.js";
import { n as logConfigUpdated } from "./logging-BnUUuH3y.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-I3Y60zVN.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CWkBweWW.js";
import { t as runTui } from "./tui-BFO6Fq--.js";
import { t as resolveNodeService } from "./node-service-BW_LhY5w.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-BnjMmWWT.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-C6Ud1gNT.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BZb1Uwsd.js");
