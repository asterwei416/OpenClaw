import { $ as formatUsageReportLines, Ct as waitForGatewayReachable, Et as normalizeControlUiBasePath, On as getMemorySearchManager, Ot as getRemoteSkillEligibility, Q as loadProviderUsageSummary, St as summarizeExistingConfig, _t as printWizardHeader, bt as resolveControlUiLinks, dt as formatControlUiSshHint, gr as peekSystemEvents, gt as openUrl, ht as normalizeGatewayTokenInput, lr as lookupContextTokens, lt as detectBrowserOpenSupport, m as listAgentsForGateway, ot as DEFAULT_WORKSPACE, pt as handleReset, st as applyWizardMetadata, ut as ensureWorkspaceAndSessions, vt as probeGatewayReachable, yt as randomToken } from "./reply-Dxp745JA.js";
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-BDd7_JUB.js";
import { H as parseAgentSessionKey, N as normalizeAgentId, c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-CrgUOY3f.js";
import { D as info, L as isRich, R as theme, c as defaultRuntime, l as restoreTerminalState } from "./subsystem-46MXi6Ip.js";
import { h as resolveUserPath, v as sleep } from "./utils-Dg0Xbl6w.js";
import { n as runExec } from "./exec-CTo4hK94.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-CJKDUIBP.js";
import { _t as DEFAULT_MODEL, gt as DEFAULT_CONTEXT_TOKENS, l as resolveConfiguredModelRef, ot as ensureAuthProfileStore, vt as DEFAULT_PROVIDER } from "./model-selection-qIT4GiGk.js";
import { t as formatCliCommand } from "./command-format-BQK1OIvH.js";
import { M as VERSION, a as readConfigFileSnapshot, r as loadConfig, s as writeConfigFile } from "./config-NosW-t65.js";
import { n as listChannelPlugins } from "./plugins-D1CxUobm.js";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-CdA5pPyg.js";
import { d as inspectPortUsage, f as resolveLsofCommandSync, p as formatPortDiagnostics } from "./chrome-D2LUApAY.js";
import { o as resolveStorePath } from "./paths-50eo6DV6.js";
import { t as buildChannelSummary } from "./channel-summary-B6ZoW49t.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-Cjf3APL3.js";
import { n as withProgress } from "./progress-uNDQDtGB.js";
import { a as summarizeRestartSentinel, i as readRestartSentinel } from "./restart-sentinel-CdcBcziq.js";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-Cvk3mQDZ.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-Cw9kFCkw.js";
import { n as logConfigUpdated } from "./logging-CLCWl7Iu.js";
import { t as WizardCancelledError } from "./prompts-CIDznuZR.js";
import { c as promptDefaultModel, h as applyAuthChoice, m as warnIfModelConfigLooksOff, p as resolvePreferredProviderForAuthChoice, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as ensureControlUiAssetsBuilt, v as promptAuthChoiceGrouped } from "./onboard-skills-z9T-nHvJ.js";
import { n as setupChannels } from "./onboard-channels-D4jAA1kf.js";
import { a as resolveHeartbeatSummaryForAgent, i as healthCommand, n as formatHealthChannelLines, t as formatHealthCheckFailure } from "./health-format-D_VP8QJD.js";
import { c as compareSemverStrings, g as resolveEffectiveUpdateChannel, h as normalizeUpdateChannel, m as formatUpdateChannelLabel, s as checkUpdateStatus } from "./update-runner-s8Rs8ex3.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-BbyfC_5k.js";
import { t as renderTable } from "./table-DuNe7Qes.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CSCMqNZP.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-CAxAjHNB.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CNYEkRek.js";
import { o as readLastGatewayErrorLine } from "./service-audit-B3lm01KZ.js";
import { t as resolveNodeService } from "./node-service-CjtBRyjp.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-C9vMMPG0.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-hyFOmVZc.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-4nnd-xrd.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CZHTiy3q.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-XV9oQICf.js";
import { t as runTui } from "./tui-v240xX8W.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DemNCT5l.js");
	...
	const tokenParam = settings.authMode === "token" && settings.gatewayToken ? `?token=${encodeURIComponent(settings.gatewayToken)}` : "";
	...
	await prompter.note([
		...
		tokenParam ? `Web UI (with token): ${authedUrl}` : void 0,
	...
	await prompter.outro(controlUiOpened ? "Onboarding complete. Dashboard opened with your token; keep that tab to control OpenClaw." : "Onboarding complete. Use the tokenized dashboard link above to control OpenClaw.");
	return { launchedTui };
}
...
//#endregion
export { buildAgentSummaries as a, loadAgentIdentity as c, loadAgentIdentityFromWorkspace as d, parseIdentityMarkdown as f, applyAgentConfig as i, pruneAgentConfig as l, statusCommand as n, findAgentEntryIndex as o, forceFreePortAndWait as p, getStatusSummary as r, listAgentEntries as s, runOnboardingWizard as t, identityHasValues as u };