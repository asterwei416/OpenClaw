...
import { A as normalizeAccountId$1, C as resolveOpenClawPackageRootSync, D as buildAgentMainSessionKey, M as normalizeMainKey, N as resolveAgentIdFromSessionKey, T as DEFAULT_AGENT_ID, _ as DEFAULT_TOOLS_FILENAME, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, j as normalizeAgentId, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, w as DEFAULT_ACCOUNT_ID, y as ensureAgentWorkspace } from "./agent-scope-COnICB_7.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DQU7mIqX.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DQU7mIqX.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { resolveCacheTtlMs as $, buildBootstrapContextFiles as $t, isContextOverflowError as A, normalizeWhatsAppTarget as An, resizeToJpeg as At, ensureSandboxWorkspaceForSession as B, listEnabledDiscordAccounts as Bn, loadWorkspaceSkillEntries as Bt, classifyFailoverReason as C, mediaKindFromMime as Cn, registerBrowserRoutes as Ct, isAuthAssistantError as D, listChannelPlugins as Dn, getImageMetadata as Dt, getApiErrorPayloadFingerprint as E, getChannelPlugin as En, convertHeicToJpeg as Et, isRawApiErrorPayload as F, listBindings as Fn, createPinnedDispatcher as Ft, loadSessionStore as G, resolveSandboxConfigForAgent as Gt, resolveSandboxRuntimeStatus as H, normalizeDiscordToken as Hn, resolvePluginSkillDirs as Ht, isTimeoutErrorMessage as I, resolveSlackAccount as In, resolvePinnedHostname as It, saveSessionStore as J, expandPolicyWithPluginGroups as Jt, readSessionUpdatedAt as K, buildPluginToolGroups as Kt, parseImageDimensionError as L, resolveSlackAppToken as Ln, resolvePinnedHostnameWithPolicy as Lt, isFailoverErrorMessage as M, listTelegramAccountIds as Mn, saveMediaBuffer as Mt, isLikelyContextOverflowError as N, resolveTelegramAccount as Nn, SsrFBlockedError as Nt, isCloudCodeAssistFormatError as O, normalizeChannelId as On, hasAlphaChannel as Ot, isRateLimitAssistantError as P, resolveTelegramToken as Pn, closeDispatcher as Pt, isCacheEnabled as Q, stripPluginOnlyAllowlist as Qt, parseImageSizeError as R, resolveSlackBotToken as Rn, buildWorkspaceSkillCommandSpecs as Rt, isGoogleModelApi as S, maxBytesForKind as Sn, createBrowserRouteContext as St, formatRawAssistantErrorForUi as T, resolveSignalAccount as Tn, resolveProfile as Tt, appendAssistantMessageToSessionTranscript as U, applySkillEnvOverrides as Ut, resolveSandboxContext as V, resolveDiscordAccount as Vn, resolveSkillsPromptForRun as Vt, resolveMirroredTranscriptText as W, applySkillEnvOverridesFromSnapshot as Wt, updateSessionStore as X, normalizeToolName as Xt, updateLastRoute as Y, expandToolGroups as Yt, updateSessionStoreEntry as Z, resolveToolProfilePolicy as Zt, sanitizeSessionMessagesImages as _, imageMimeFromFormat as _n, resolveChannelGroupRequireMention as _t, formatXHighModelHint as a, isInternalMessageChannel as an, resolveSessionKey as at, downgradeOpenAIReasoningBlocks as b, kindFromMime as bn, resolveConversationLabel as bt, normalizeReasoningLevel as c, normalizeMessageChannel as cn, resolveSessionResetPolicy as ct, normalizeVerboseLevel as d, GATEWAY_CLIENT_IDS as dn, DEFAULT_RESET_TRIGGERS as dt, ensureSessionHeader$1 as en, deliveryContextFromSession as et, resolveResponseUsageMode as f, GATEWAY_CLIENT_MODES as fn, resolveMainSessionKey as ft, normalizeTextForComparison as g, getFileExtension as gn, resolveChannelGroupPolicy as gt, isMessagingToolDuplicateNormalized as h, extensionForMime as hn, listChannelDocks as ht, formatThinkingLevels as i, isDeliverableMessageChannel as in, normalizeSessionDeliveryFields as it, isFailoverAssistantError as j, listEnabledTelegramAccounts as jn, getMediaDir as jt, isCompactionFailureError as k, isWhatsAppGroupJid as kn, optimizeImageToPng as kt, normalizeThinkLevel as l, resolveGatewayMessageChannel as ln, resolveSessionResetType as lt, isMessagingToolDuplicate as m, detectMime as mn, getChannelDock as mt, validateGeminiTurns as n, sanitizeGoogleTurnOrdering as nn, mergeDeliveryContext as nt, listThinkingLevels as o, isMarkdownCapableMessageChannel as on, evaluateSessionFreshness as ot, supportsXHighThinking as p, GATEWAY_CLIENT_NAMES as pn, deriveSessionMetaPatch as pt, recordSessionMetaFromInbound as q, collectExplicitAllowlist as qt, pickFallbackThinkingLevel as r, INTERNAL_MESSAGE_CHANNEL as rn, normalizeDeliveryContext as rt, normalizeElevatedLevel as s, listDeliverableMessageChannels as sn, resolveChannelResetConfig as st, validateAnthropicTurns as t, resolveBootstrapMaxChars as tn, deliveryContextKey as tt, normalizeUsageDisplay as u, resolveMessageChannel as un, resolveThreadFlag as ut, sanitizeImageBlocks as v, isAudioFileName as vn, resolveChannelGroupToolsPolicy as vt, formatAssistantErrorText as w, listEnabledSignalAccounts as wn, resolveBrowserConfig as wt, isAntigravityClaude as x, MAX_IMAGE_BYTES$1 as xn, resolveGroupSessionKey as xt, sanitizeToolResultImages as y, isGifMedia as yn, resolveIMessageAccount as yt, sanitizeUserFacingText as z, normalizeChatType as zn, buildWorkspaceSkillSnapshot as zt };