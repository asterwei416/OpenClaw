...
async function runGatewayUpdate(opts = {}) {
	...
	if (gitRoot && pkgRoot && path.resolve(gitRoot) === path.resolve(pkgRoot)) {
		...
		const restoreUiStep = await runStep(step("restore control-ui", [
			"git",
			"-C",
			gitRoot,
			"checkout",
...
//#endregion
export { globalInstallArgs as a, compareSemverStrings as c, DEFAULT_GIT_CHANNEL as d, DEFAULT_PACKAGE_CHANNEL as f, resolveEffectiveUpdateChannel as g, normalizeUpdateChannel as h, detectGlobalInstallManagerForRoot as i, fetchNpmTagVersion as l, formatUpdateChannelLabel as m, cleanupGlobalRenameDirs as n, resolveGlobalPackageRoot as o, channelToNpmTag as p, detectGlobalInstallManagerByPresence as r, checkUpdateStatus as s, runGatewayUpdate as t, resolveNpmChannelTag as u };