...
import { At as installUnhandledRejectionHandler } from "./loader-DX0InoAJ.js";
...
import { i as getCommandPath, s as getPrimaryCommand, u as hasHelpOrVersion } from "./register.subclis-DuQAUmQk.js";
...
import { a as findRoutedCommand, n as emitCliBanner, t as ensureConfigReady } from "./config-guard-CME9KK27.js";
...
async function runCli(argv = process$1.argv) {
	...
	const { buildProgram } = await import("./program-CvD04Sy8.js");
	...
	if (primary) {
		const { registerSubCliByName } = await import("./register.subclis-DzEOMHcD.js");
		await registerSubCliByName(program, primary);
	}
	if (!(!primary && hasHelpOrVersion(parseArgv))) {
		const { registerPluginCliCommands } = await import("./cli-DR9R1gDi.js");
		const { loadConfig } = await import("./config-BzEJhHk7.js");
